# Sequential-Semantic-tasks-with-Petoi-Bittle-Bot-using-GPT-4.o
...
### Configure OpenAI API — edit `LLM_reasoning_node.py` line 61
```python
...
### Configure Mission Goals — edit `LLM_reasoning_node.py` lines 23 – 26
```python
self.mission_goals = [
